...
private:
    ...
    bool is_value(value_type& t) {
        return is_string(t) || is_number(t) || is_object(t) || is_array(t) || is_bool(t) ||
               is_null(t);
    }
    ...
    */
    ...
    char* utf8(std::uint32_t x, char* f) {
        ...
        if (x < 0x80)
            ...
            require(false, "valid utf-32 character");
        ...
        case 4:
            *--f = static_cast<char>((x | mark) & mask);
            x >>= 6;
        case 3:
            *--f = static_cast<char>((x | mark) & mask);
            x >>= 6;
        case 2:
            *--f = static_cast<char>((x | mark) & mask);
            x >>= 6;
        case 1:
            *--f = static_cast<char>(x | first_mark[bytes_to_write]);
        }
    ...
    static const table_t_& hex_digit() {
        static const char hex_digit_[] = {
            ...
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 2 */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 3 */ '\x00', '\x01', '\x02', '\x03', '\x04', '\x05', '\x06', '\x07',
            '\x08',         '\x09', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 4 */ '\xFF', '\x0A', '\x0B', '\x0C', '\x0D', '\x0E', '\x0F', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 5 */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 6 */ '\xFF', '\x0A', '\x0B', '\x0C', '\x0D', '\x0E', '\x0F', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 7 */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 8 */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* 9 */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* A */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* B */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* C */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* D */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            /* E */ '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
            '\xFF',         '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF', '\xFF',
    ...
    static const table_t_& escape() {
        static const char escape_[] = {
            ...
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            /* 2 */ '\x00', '\x00', '\x22', '\x00', '\x00', '\x00', '\x00', '\x00',
            ...
            '\x00',         '\x00', '\x00', '\x00', '\x5C', '\x00', '\x00', '\x00',
            /* 6 */ '\x00', '\x00', '\x08', '\x00', '\x00', '\x00', '\x0C', '\x00',
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x0A', '\x00',
            /* 7 */ '\x00', '\x00', '\x0D', '\x00', '\x09', '\x75', '\x00', '\x00',
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
    ...
    static const table_t_& ws() {
        static const char ws_[] = {
            ...
            /* 1 */ '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            /* 2 */ '\x01', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            /* 3 */ '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            '\x00',         '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
            /* 4 */ '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
...
private:
    ...
    void generate_(bool x) {
        ...
        if (x)
            out_ = std::copy(std::begin(true_), std::end(true_) - 1, out_);
        else
            out_ = std::copy(std::begin(false_), std::end(false_) - 1, out_);
    }
    ...
    template <typename U>
    static const U& as(const value_type& x) {
        return T::template as<U>(x);
    }

    void indent(std::size_t n) {
        for (std::size_t n_ = 0; n_ != n; ++n_)
            *out_++ = '\t';
    }
    void space() { *out_++ = ' '; }
    void endl() { *out_++ = '\n'; }
    ...
    void generate_(const pair_type& value, std::size_t n) {
        generate_string(value.first);
        *out_++ = ':';
        space();
        generate_(value.second, n);
    }
