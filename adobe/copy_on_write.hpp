...
// Trying to fix a few issues in the adobe_source_libraries develop branch without having to
// pull stlab sources, so the lines between {BEGIN,END} COPY <stlab/copy_on_write.hpp> is a
// copy+paste of the stlab source file.
// BEGIN COPY <stlab/copy_on_write.hpp>
/*
    Copyright 2013 Adobe
    Distributed under the Boost Software License, Version 1.0.
    (See accompanying file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
...
/**************************************************************************************************/
// END COPY <stlab/copy_on_write.hpp>
