...
BOOST_AUTO_TEST_CASE(fnv_smoke) {
...
#ifndef ADOBE_FNV_NO_BIGINTS
    {
        std::string lorem_ipsum("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do "
        ...
        multiprecision_test(
            lorem_ipsum, 0xb7c3ecf4, 0x72133ab33927ecf4,
...

    {
        ...
        multiprecision_test(
            hello_world, 0xed90f094, 0x38d1334144987bf4,
