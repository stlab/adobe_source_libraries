...
aggregate_name_t bitwise_and_k          = { ".bitwise_and" };
aggregate_name_t bitwise_xor_k          = { ".bitwise_xor" };
aggregate_name_t bitwise_or_k           = { ".bitwise_or" };
aggregate_name_t bitwise_rshift_k       = { ".bitwise_rshift" };
aggregate_name_t bitwise_lshift_k       = { ".bitwise_lshift" };
aggregate_name_t bitwise_negate_k       = { ".bitwise_negate" };
