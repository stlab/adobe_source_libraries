...
struct bitwise_and_t : public std::binary_function<boost::uint32_t, boost::uint32_t, boost::uint32_t>
{
    inline boost::uint32_t operator() (boost::uint32_t x, boost::uint32_t y) const
    {
        return x & y;
    }
};
...
struct bitwise_xor_t : public std::binary_function<boost::uint32_t, boost::uint32_t, boost::uint32_t>
{
    inline boost::uint32_t operator() (boost::uint32_t x, boost::uint32_t y) const
    {
        return x ^ y;
...
struct bitwise_or_t : public std::binary_function<boost::uint32_t, boost::uint32_t, boost::uint32_t>
{
    inline boost::uint32_t operator() (boost::uint32_t x, boost::uint32_t y) const
    {
        return x | y;
...
struct bitwise_rshift_t : public std::binary_function<boost::uint32_t, boost::uint32_t, boost::uint32_t>
{
    inline boost::uint32_t operator() (boost::uint32_t x, boost::uint32_t y) const
    {
        return x >> y;
...
struct bitwise_lshift_t : public std::binary_function<boost::uint32_t, boost::uint32_t, boost::uint32_t>
{
    inline boost::uint32_t operator() (boost::uint32_t x, boost::uint32_t y) const
    {
        return x << y;
...
{
    inline boost::uint32_t operator() (boost::uint32_t x) const
    {
        return ~x;
    }
};
...
void virtual_machine_init_()
{
    ...
    {{
        ...
        op_entry_type(adobe::bitwise_and_k,     &implementation_t::bitwise_binary_operator<bitwise_and_t>),
        op_entry_type(adobe::bitwise_xor_k,     &implementation_t::bitwise_binary_operator<bitwise_xor_t>),
        op_entry_type(adobe::bitwise_or_k,      &implementation_t::bitwise_binary_operator<bitwise_or_t>),
        op_entry_type(adobe::bitwise_rshift_k,  &implementation_t::bitwise_binary_operator<bitwise_rshift_t>),
        op_entry_type(adobe::bitwise_lshift_k,  &implementation_t::bitwise_binary_operator<bitwise_lshift_t>),
        op_entry_type(adobe::bitwise_negate_k,  &implementation_t::bitwise_unary_operator<bitwise_negate_t>)
    }};
...
void virtual_machine_t::override_operator(name_t operator_name, const binary_op_override_t& override)
{
