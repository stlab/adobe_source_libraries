...
Adobe::Codex2::Types::note - Define Codex type data.
...
# Module setup.
# -------------------------------------------------------------------------
package Adobe::Codex2::Types::note;
...
sub Data
{
    ...
    # Process data.
    $note{'id'}   = $Data->{'id'}          if (exists $Data->{'id'});
    $note{'text'} = $Data->{'__content__'} if (exists $Data->{'__content__'});
